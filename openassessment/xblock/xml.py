...
def serialize_content_to_xml(oa_block, root):
    ...
    if oa_block.submission_due_empty is not None:
        root.set('submission_due_empty', six.text_type(oa_block.submission_due_empty))
...
def parse_from_xml(root):
    ...
    if 'submission_due_empty' in root.attrib:
        submission_due_empty = _parse_boolean(six.text_type(root.attrib['submission_due_empty']))
